...
# Creating the argument parser
    ...
    # Poweron VM
    poweron_parser = subparsers.add_parser('poweron', help='Power ON the given VM')
    poweron_parser.add_argument('-sn', '--sname', action='store', required=False, help='Power ON the given VM', dest='snamep', type=str)
...
try: 
    ...
    if hasattr(args, 'lall'):
      ...
      i = list_snapshot(vm)
      pass
    elif hasattr(args, 'snamep'):
      logger.debug('Powering on VM as requested by user.')
      i = power_on(vm)
      pass
